...
namespace Saving_Accelerator_Tool
{
    class PCRaports_Genereted
    {
        ...
        //private DataRow CalcSpecjal(DataRow Action, string Rewizja, decimal Euro, ref System.Data.DataTable ANC, ref System.Data.DataTable PNC)
        //{
        ...
        //private decimal SteadyQuantityBring(DataRow Action, string Rewizja, ref System.Data.DataTable ANC, ref System.Data.DataTable PNC)
        //{
        //    decimal Steady = 0;
        ...
        //private decimal BringDelta(DataRow Action, bool Calc)
        //{
        //    decimal Delta = 0;

        //    if(Calc)
        //    {
        //        if(Action["Calculate"].ToString() == "ANC" || Action["Calculate"].ToString() == "PNC")
        //        {
        //            string[] Help = Action["Delta"].ToString().Split('|');

        //            for(int counter =1; counter<Help.Length-1; counter++)
        //            {
        //                Delta = Delta + decimal.Parse(Help[counter]);
        //            }
        //            Delta = Delta / (Help.Length - 1);
        //            return Delta;
        //        }

        //        if(Action["Calculate"].ToString() == "ANCSpec")
        //        {
        //            string[] Help = Action["Delta"].ToString().Split('|');
        ...
        //        {
        //            string[] Help = Action["PNCSumDelta"].ToString().Split('|');
        ...
        //        if (Action["Calculate"].ToString() == "ANC" || Action["Calculate"].ToString() == "PNC")
        //        {
        //            string[] Help = Action["STKCal"].ToString().Split('|');
        ...
        //        if (Action["Calculate"].ToString() == "PNCSpec")
        //        {
        //            Delta = decimal.Parse(Action["PNCEstyma"].ToString());
        //            return Delta;
        //        }
        //    }
